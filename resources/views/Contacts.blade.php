...
<header class="bg-w w-100 ff-SFNSD">
    <div class="container h2 p-3 text-info"><a href="{{route('home')}}" style="text-decoration: none;">Etusivu</a><a href="{{route('company')}}" style="padding-left: 22px;text-decoration: none;">Yritys</a><a href="{{route('contacts')}}" style="padding-left: 22px;text-decoration: none;">Yhteystiedot</a></div>
</header>
    ...
    <form action="{{Route('loanstore')}}" method="POST" name="loanForm" id="loanForm" novalidate>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 block_1_2 bg-w border-bottom" id="border-bottom">
                <div class="mt-4 h3 ff-SFNSD text-info text-center">Ota meihin yhteyttä  
                </div>
                <hr style="width: 240px">
                <div class="item form-group input-text">
                    <label class="h4 text-info">
                        Nimi:</label>
                    <input class="required" name="Name" placeholder="Anna nimi" type="text" id="" />
                </div>
                <div class="item form-group input-text">
                    <label class="h4 text-info">
                        Sähköposti:</label>
                    <input class="required" name="from_email" placeholder="xyz@gmail.com" type="text" id="from_email" />
                </div>
                <div class="item form-group input-text item">
                    <label class="h4 text-info">aihe:</label>
                    <input class="required" name="from_phone" placeholder="aihe" type="text" id="from_phone"/>
                </div>
                <div class="item form-group input-text item">
                    <label class="h4 text-info">Kuvaus:</label><br/>
                    <textarea name="subject" placeholder="Kirjoittaa jotain.." style="width: 100%;height: 100px;"></textarea>
                </div>
